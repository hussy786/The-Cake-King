...
function zerif_scripts()
{
    ...
    wp_enqueue_style('zerif_owl_theme_style', get_template_directory_uri() . '/css/bootstrap.min.css');
    wp_enqueue_style('zerif_owl_theme_style1', get_template_directory_uri() . '/css/flexslider.css');
    wp_enqueue_style('zerif_owl_theme_style2', get_template_directory_uri() . '/css/jquery.jscrollpane.custom.css');
    wp_enqueue_style('zerif_owl_theme_style3', get_template_directory_uri() . '/css/jquery.bxslider.css');
    wp_enqueue_style('zerif_owl_theme_style4', get_template_directory_uri() . '/css/lightbox.css');
    wp_enqueue_style('zerif_owl_theme_style5', get_template_directory_uri() . '/fonts/css/font-awesome.min.css');
    wp_enqueue_style('zerif_owl_theme_style6', get_template_directory_uri() . '/icons/flaticon.css');
    wp_enqueue_style('zerif_owl_theme_style7', get_template_directory_uri() . '/css/styles.css');
    ...
    */
    ...
    wp_enqueue_script('king_script', get_template_directory_uri() . '/js/jquery.min.js');
    wp_enqueue_script('king_script1', get_template_directory_uri() . '/js/jquery-ui-1.10.4.custom.min.js');
    wp_enqueue_script('king_script2', get_template_directory_uri() . '/js/bootstrap.min.js');
    wp_enqueue_script('king_script3', get_template_directory_uri() . '/js/jquery.flexslider-min.js');
    wp_enqueue_script('king_script4', get_template_directory_uri() . '/js/jquery.bxslider.min.js');
    wp_enqueue_script('king_script5', get_template_directory_uri() . '/js/lightbox-2.6.min.js');
    wp_enqueue_script('king_script6', get_template_directory_uri() . '/js/accordion.js');
    wp_enqueue_script('king_script7', get_template_directory_uri() . '/js/skroll.js');
    wp_enqueue_script('king_script8', get_template_directory_uri() . '/js/modernizr.custom.js');
    wp_enqueue_script('king_script9', get_template_directory_uri() . '/js/main.js');
    /* Bootstrap script */
