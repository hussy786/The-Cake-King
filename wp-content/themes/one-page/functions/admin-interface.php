...
function onepage_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1>Get BusinessGrow Theme PRO!</h1>
        <p style="font-size:15px; line-height: 20px;">You are using the One page Lite Version of BusinessGrow Theme. Upgrade to Pro for extra features like Home Page Slider, Homepage Hexagonal Gallery, FullWidth Page Templates, Multiple Color Options, Life time theme support and much more.</p>
        <a href="http://www.inkthemes.com/wp-themes/business-grow-one-page-wordpress-theme/" target="blank">Upgrade to BusinessGrow PRO Theme here >></a>
    </div>
